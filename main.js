...
document.addEventListener('DOMContentLoaded', ()=>{
  ...
  /* LIGHTBOX FOR UPCOMING TOURS IMAGES */
  document.querySelectorAll(".dest-grid .card img").forEach(img=>{
  ...
  /* booking form: mailto + whatsapp fallback */
  ...
  if(bookingForm){
    bookingForm.addEventListener('submit', function(e){
      ...
      // WhatsApp fallback
      setTimeout(()=> 
        window.open(`https://wa.me/27739528645?text=${encodeURIComponent(body)}`,'_blank')
      ,600);
